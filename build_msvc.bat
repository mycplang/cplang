...
set "STDLIB_SRCS=src\stdlib\stdlib.cpp src\stdlib\stdlib_aes.cpp src\stdlib\stdlib_algo_bitwise.cpp src\stdlib\stdlib_algo_ext.cpp src\stdlib\stdlib_algo_missing.cpp src\stdlib\stdlib_array.cpp src\stdlib\stdlib_array_file_more.cpp src\stdlib\stdlib_bitset.cpp src\stdlib\stdlib_charset.cpp src\stdlib\stdlib_complex_pair.cpp src\stdlib\stdlib_containers.cpp src\stdlib\stdlib_crypto_impl.cpp src\stdlib\stdlib_crypto_plus.cpp src\stdlib\stdlib_db.cpp src\stdlib\stdlib_encoding.cpp src\stdlib\stdlib_ffi.cpp src\stdlib\stdlib_file.cpp src\stdlib\stdlib_file_log.cpp src\stdlib\stdlib_heap.cpp src\stdlib\stdlib_http.cpp src\stdlib\stdlib_io.cpp src\stdlib\stdlib_iterator.cpp src\stdlib\stdlib_json_http.cpp src\stdlib\stdlib_map.cpp src\stdlib\stdlib_math.cpp src\stdlib\stdlib_math_special.cpp src\stdlib\stdlib_matrix_color_path_console.cpp src\stdlib\stdlib_misc_modules.cpp src\stdlib\stdlib_net_ws_sql.cpp src\stdlib\stdlib_numeric_limits.cpp src\stdlib\stdlib_p1_enhance.cpp src\stdlib\stdlib_p2_more.cpp src\stdlib\stdlib_p3_util.cpp src\stdlib\stdlib_r10_r11.cpp src\stdlib\stdlib_raylib.cpp src\stdlib\stdlib_redis.cpp src\stdlib\stdlib_reflect.cpp src\stdlib\stdlib_regex.cpp src\stdlib\stdlib_stats_utils.cpp src\stdlib\stdlib_str_search.cpp src\stdlib\stdlib_string.cpp src\stdlib\stdlib_string_ext.cpp src\stdlib\stdlib_string_more_impl.cpp src\stdlib\stdlib_table.cpp src\stdlib\stdlib_threading.cpp src\stdlib\stdlib_time_sys_more.cpp src\stdlib\stdlib_time_system.cpp src\stdlib\stdlib_types_net.cpp src\stdlib\stdlib_variant_utils.cpp src\stdlib\stdlib_fix_missing.cpp src\stdlib\stdlib_stubs.cpp src\stdlib\stdlib_imgui.cpp"
set "SRCS=src\main.cpp src\core\verbose.cpp src\lexer\lexer.cpp src\parser\parser.cpp src\parser\parser_decl.cpp src\parser\parser_stmt.cpp src\parser\parser_expr.cpp src\semantic\semantic_analyzer.cpp src\codegen\codegen.cpp src\codegen\codegen_opt.cpp src\codegen\codegen_stmt.cpp src\codegen\codegen_expr.cpp src\codegen\bytecode_optimizer.cpp src\vm\vm.cpp src\vm\vm_containers.cpp src\vm\vm_objects.cpp src\vm\vm_exec.cpp src\vm\value.cpp src\jit\jit_dispatch.cpp src\vm\vm_opt_stub.cpp src\repl.cpp !STDLIB_SRCS! src\miniz.c src\miniz_tdef.c src\miniz_tinfl.c src\crypto\md5_impl.cpp src\sqlite\sqlite3.c src\optimizer\optimizer.cpp src\optimizer\constant_folder.cpp src\optimizer\dead_code_eliminator.cpp src\optimizer\function_inliner.cpp src\optimizer\tail_recursion_optimizer.cpp src\optimizer\loop_unroller.cpp src\optimizer\escape_analyzer.cpp src\module\module_system.cpp src\exception\exception_handler.cpp src\debug\debugger.cpp src\aot\aot_vm_bridge.cpp "
...
if exist build\*.obj (
    ...
    if exist build\stdlib_raylib.obj ren build\stdlib_raylib.obj stdlib_raylib.obj.hide
    ...
    for %%x in (rcore rshapes rtextures rtext rmodels raudio rglfw imgui imgui_draw imgui_tables imgui_widgets rlImGui stdlib_raylib stdlib_imgui) do (
